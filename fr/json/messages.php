...
<body>
    ...
    <div class="container">
    <?php
        $arr = file_get_contents("data/message.json");
    ...
    ?>
        <div class="card mt-3">
            <div class="row">
                ...
                <a href="traitement.php?id=<?php echo $user['email']?>" class="btn btn-danger action">
                ...
                <a href="update.php?id=<?php echo $user['id']?>" class="btn btn-warning action">
                ...
                <div class="col">
                    ...
                    <div class="">
                        Name: <?php echo $user['nom'] ?>
                    </div>
                    <div class="">
                        Email: <?php echo $user['email'] ?>
                    </div>
                    <div class="">
                        Message: <?php echo $user['note'] ?>
                    </div>
                    <div class="">
                        Message: <?php echo $user['date'] ?>
                    </div>
                </div>
            </div>
        </div>
